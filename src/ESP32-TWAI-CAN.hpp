...
// --------------------------------
// Add custom Speed 666.666 kBit
/* Baurate calculator from

http://www.bittiming.can-wiki.info/

Clockrate is 80 MHz according to
https://esp32.com/viewtopic.php?t=23719
#define FSYS  80000000

Standard samplepoint from CANalyzer
Standard SJW from CANalyzer
 */
#define TWAI_TIMING_CONFIG_666KBITS() {.brp = 6, .tseg_1 = 16, .tseg_2 = 3, .sjw = 2, .triple_sampling = false}
// --------------------------------
